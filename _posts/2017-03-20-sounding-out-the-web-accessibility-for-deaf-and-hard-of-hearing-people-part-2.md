...
<img src="{{ site.baseurl }}/public/images/YorkStJohn-Youtube-Video-Captions.png" alt="The YouTube video player showing a video about York St John University with closed captions switched on. The captions are displayed over two lines with the end of the sentence cut off." class="float-right">“Subtitles, that’s the really obvious one”, remarks Ruth as we discuss the things that help her the most. In my previous post, she described the frustration of viewing a video posted on Facebook that lacked subtitles.
...
This [article by Tom Mitchell at JISC](https://jiscdigicomms.jiscinvolve.org/wp/2016/10/18/the-value-of-online-video-subtitles/) highlights the benefits of captions towards accessibility, and he describes how you can add them to videos on YouTube and Facebook.
...
“When you’re deaf, you want it to run in time” explains Ruth. She cites two examples of good practices: the [Lynda.com](https://www.lynda.com/) training videos and the British Universities Film & Video Council’s [BoB (Box of Broadcasts)](https://learningonscreen.ac.uk/ondemand) service. “I sometimes notice a couple of seconds’ delay,” Ruth remarks, “but on the whole, it’s good.”
...
Ruth shares a [blog post by Molly Watt](https://www.mollywatt.com/blog/entry/my-apple-watch-after-5-days), an inclusive technology advocate who is deaf-blind. Molly’s post describes her experience of using an Apple Watch and the way that its haptic feedback has proven particularly useful for navigating.
